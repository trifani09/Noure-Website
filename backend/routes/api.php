...
Route::prefix('v1')->group(function (): void {
    ...
    Route::post('cart/discount', [CartController::class, 'applyDiscount'])->name('api.v1.cart.discount.store');
    Route::delete('cart/discount', [CartController::class, 'removeDiscount'])->name('api.v1.cart.discount.destroy');
