    ...
    <section id="story" className="bg-ivory section-space">
      <div className="page-shell grid items-center gap-12 md:grid-cols-2">
        {imageUrl ? (
          ...
          <div className="mx-auto aspect-square w-full max-w-lg bg-[radial-gradient(circle_at_30%_30%,#ded4ca,#72525f_90%)] p-8">
            <div className="flex h-full items-center justify-center border border-paper/50">
              <span className="editorial-title text-5xl tracking-[.25em] text-paper">
                N
              </span>
            </div>
          </div>
