  ...
  return (
    <section className="page-shell py-20 md:py-28">
      ...
      <div className="mt-12 text-center">
        <Link
          href={section.configuration.cta_url ?? "/products"}
          className="border-b border-ink pb-1 text-xs font-semibold uppercase tracking-[.18em]"
        >
          {section.configuration.cta_label ?? "Discover the collection"}
        </Link>
      </div>
    </section>
  );
